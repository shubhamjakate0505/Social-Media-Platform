                        ...
                        <div>
                          ...
                          <div className={styles.optionContainer}>
                            ...
                            <div onClick={() => {
                              ...
                              const url = encodeURIComponent("hii");
                              const twitterurl = `https://twitter.com/intent?text=${text}&url${url}}`
                  ...
                  <div>
                    ...
                    {postState.comments.map((comment, index) => {
                      ...
                      return (
                        ...
                        <div className={styles.singleComments} key={comment._id}>
                          <div className={styles.singleComments_profileContainer}>
                            {/* <img src={`${BaseURl}/${comment.userId.profilePicture}`} alt="" /> */}
                            <img
                              src={
                                comment?.userId?.profilePicture
                                  ? `${BaseURl}/${comment.userId.profilePicture}`
